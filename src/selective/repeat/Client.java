...
public class Client {
   ...
   public int clientPortNum;
   public String requestFile;
   public String outputFile ;
   public int windowSize;
    private static InetAddress ipAddress;

    public Client(String serverIp, int serverPortNum, int clientPortNum, String requestFile, String outputFile,int windowSize) {
		super();
   ...
   public Client() {
	   super();
		...
		this.serverPortNum = 3030;
		this.clientPortNum = 7070;
		this.requestFile = "";
		this.outputFile = "";
		this.windowSize=30;
		 winSize = windowSize;
